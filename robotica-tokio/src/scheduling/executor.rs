...
const FIRST_OFFSET: TimeDelta = time_delta_constant!(-1 days);
const LAST_OFFSET: TimeDelta = time_delta_constant!(4 days);
...
impl<T: TimeZone + Copy> State<T> {
    ...
    const POLL_INTERVAL: TimeDelta = time_delta_constant!(1 minutes);
